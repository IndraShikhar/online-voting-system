...
import { LayoutDashboard, LogOut, BarChart3, User, ListChecks, UserPlus, Users } from "lucide-react";
...
export function AdminSidebar() {
    ...
    const links = [
        ...
        },
        {
            ...
            icon: <ListChecks className="text-neutral-300 hover:text-emerald-400 h-6 w-6 shrink-0 transition-colors duration-200" />,
            gradient: "from-emerald-500 to-green-500"
        },
        {
            label: "Candidates",
            href: "/admin/candidates",
            icon: <UserPlus className="text-neutral-300 hover:text-purple-400 h-6 w-6 shrink-0 transition-colors duration-200" />,
            gradient: "from-purple-500 to-pink-500"
        },
        {
            label: "Voters",
            href: "/admin/voters",
            icon: <Users className="text-neutral-300 hover:text-yellow-400 h-6 w-6 shrink-0 transition-colors duration-200" />,
            gradient: "from-yellow-500 to-orange-500"
        },
        {
            label: "Results",
            href: "/admin/results",
            icon: <BarChart3 className="text-neutral-300 hover:text-indigo-400 h-6 w-6 shrink-0 transition-colors duration-200" />,
